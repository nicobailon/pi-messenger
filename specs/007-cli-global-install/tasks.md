...
- [ ] **T1: Add constants + jiti resolver + wrapper function to install.mjs**
...
- [ ] **T3: Add wrapper creation call + collision guard flow update**
...
- [ ] **T4: Add CLI hard error to runtime-spawn.ts**
...
- [ ] **T5: Tests — wrapper creation/removal (T6)**
...
- [ ] **T7: Tests — spawn-time validation (T8)**
...
- [ ] **T8: Tests — AC5 crew-spawned integration (T9)**
